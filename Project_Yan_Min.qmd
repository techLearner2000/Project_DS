...
For the DNN model, the accuracy on the test set is 0.752, while on the training set, it is 0.453. There is no strong sign of overfitting. And the F1 score is 0.767, which indicates a strong balance for precison and recall in this model. The results from the DNN model are promising and could significantly benefit team strategies. 
